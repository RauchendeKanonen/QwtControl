#ifndef QWT_PHASE_CURVE_H
#define QWT_PHASE_CURVE_H
...
/*!
  ...
  <dd>QwtPhaseCurve gets its points using a QwtData object offering
  ...
  the points inside ( like QStandardItemModel ). QwtPhaseCurve also offers
...
*/
class QWT_EXPORT QwtPhaseCurve: public QThread, public QwtControlPlotItem
{
    Q_OBJECT
signals:
...
public:
    ...
    /*!
        Curve styles.
         ...
         - UserCurve\n
           ...
           classes of QwtPhaseCurve that overload drawCurve() with
    ...
    */
    ...
    /*!
      ...
      - Fitted ( in combination with the Lines QwtPhaseCurve::CurveStyle only )\n
        ...
        to fit the points, before they are passed to QwtPhaseCurve.
      - Inverted\n
    ...
    */
    ...
    explicit QwtPhaseCurve(ControlExpression *Expression, EvalInfo EvInfo);
    explicit QwtPhaseCurve(const QwtText &title, ControlExpression *Expression, EvalInfo EvInfo);
    explicit QwtPhaseCurve(const QString &title, ControlExpression *Expression, EvalInfo EvInfo);
...
inline QwtData &QwtPhaseCurve::data()
{
    return *d_xy;
}

//! \return the the curve data
inline const QwtData &QwtPhaseCurve::data() const
{
    return *d_xy;
}
...
*/
inline double QwtPhaseCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double QwtPhaseCurve::y(int i) const
{
    return d_xy->y(i);
}

#endif // QWT_PHASE_CURVE_H

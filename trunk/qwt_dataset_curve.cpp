...
class QwtDataSetCurvePaintHelper: public QObject
{
public:
    QwtDataSetCurvePaintHelper(const QwtDataSetCurve *curve, int from, int to):
        _curve(curve),
        _from(from),
        _to(to)
    {
...
class QwtDataSetCurve::PrivateData
{
public:
    ...
    QwtDataSetCurve::CurveType curveType;
    QwtDataSetCurve::CurveStyle style;
    double reference;
...
void QwtDataSetCurve::run (void)
{

}

void QwtDataSetCurve::dataReadySlot(QPolygonF Polygon)
{
}
void QwtDataSetCurve::markerChangeSlot(QPair<QString,double> MarkerPair)
{
...
//! Constructor
QwtDataSetCurve::QwtDataSetCurve(QPolygonF Dataset, EvalInfo EvInfo):
    QwtPlotItem(QwtText())
{
    init(EvInfo);
    setData(Dataset);
...
/*!
    ...
    */
QwtDataSetCurve::QwtDataSetCurve(const QwtText &title, QPolygonF Dataset, EvalInfo EvInfo):
    QwtPlotItem(title)
{
    init(EvInfo);
    setData(Dataset);
...
/*!
      ...
      \param title Title of the curve
    */
QwtDataSetCurve::QwtDataSetCurve(const QString &title, QPolygonF Dataset, EvalInfo EvInfo):
...
//! Destructor
QwtDataSetCurve::~QwtDataSetCurve()
{
    this->terminate();
    delete d_xy;
    delete d_data;
...
/*!
    ...
    */
void QwtDataSetCurve::init(EvalInfo EvInfo)
{
...
int QwtDataSetCurve::rtti() const
{
    return QwtPlotItem::Rtti_PlotUserItem+Rtti_PlotDataSet;
}
...
/*!
    ...
    */
void QwtDataSetCurve::setPaintAttribute(PaintAttribute attribute, bool on)
{
    if ( on )
...
/*!
    ...
    */
bool QwtDataSetCurve::testPaintAttribute(PaintAttribute attribute) const
{
...
/*!
      ...
      \sa CurveStyle, style()
    */
void QwtDataSetCurve::setStyle(CurveStyle style)
{
...
/*!
    ...
    */
QwtDataSetCurve::CurveStyle QwtDataSetCurve::style() const
{
    return d_data->style;
}
...
/*!
      ...
      \sa symbol()
    */
void QwtDataSetCurve::setSymbol(const QwtSymbol &symbol )
{
...
/*!
        ...
        \sa setSymbol()
    */
const QwtSymbol &QwtDataSetCurve::symbol() const
{
...
/*!
    ...
    */
void QwtDataSetCurve::setPen(const QPen &pen)
{
    if ( pen != d_data->pen )
    {
        d_data->pen = pen;
...
/*!
        ...
        \sa setPen(), brush()
    */
const QPen& QwtDataSetCurve::pen() const
{
    return d_data->pen;
}
...
/*!
      \brief Assign a brush.
       ...
       and style() != QwtDataSetCurve::Sticks
    ...
    */
void QwtDataSetCurve::setBrush(const QBrush &brush)
{
...
/*!
    ...
    */
const QBrush& QwtDataSetCurve::brush() const
{
    return d_data->brush;
}
...
/*!
    ...
    */
void QwtDataSetCurve::setData(const double *xData, const double *yData, int size)
{
    delete d_xy;
...
/*!
      ...
      \note Internally the data is stored in a QwtArrayData object
    */
void QwtDataSetCurve::setData(const QwtArray<double> &xData,
...
/*!
    ...
    */
#if QT_VERSION < 0x040000
void QwtDataSetCurve::setData(const QwtArray<QwtDoublePoint> &data)
#else
void QwtDataSetCurve::setData(const QPolygonF &data)
#endif
{
    delete d_xy;
...
/*!
      ...
      \sa QwtData::copy()
    */
void QwtDataSetCurve::setData(const QwtData &data)
{
    delete d_xy;
    d_xy = data.copy();
    itemChanged();
...
/*!
    ...
    */
void QwtDataSetCurve::setRawData(const double *xData, const double *yData, int size)
{
    delete d_xy;
...
QwtDoubleRect QwtDataSetCurve::boundingRect() const
{
    if ( d_xy == NULL )
...
/*!
    ...
    */
void QwtDataSetCurve::draw(QPainter *painter,
...
/*!
      ...
      \sa drawCurve(), drawSymbols()
    */
void QwtDataSetCurve::draw(int from, int to) const
{
    if ( !plot() )
        return;
         ...
         !canvas->testAttribute(Qt::WA_PaintOutsidePaintEvent) )
    {
        /*
              ...
              the QwtDataSetCurve::draw, but now from inside the paint
              event.
             */

        QwtDataSetCurvePaintHelper helper(this, from, to);
...
/*!
      ...
      \param painter Painter
      \param style curve style, see QwtDataSetCurve::CurveStyle
      \param xMap x map
      \param yMap y map
      \param from index of the first point to be painted
...
void QwtDataSetCurve::drawCurve(QPainter *painter, int style,
                                 const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                                 int from, int to) const
{
    switch (style)
...
/*!
    ...
    */
void QwtDataSetCurve::drawLines(QPainter *painter,
                                 const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                                 int from, int to) const
{
    int size = to - from + 1;
...
/*!
    ...
    */
void QwtDataSetCurve::drawSticks(QPainter *painter,
                                  const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                                  int from, int to) const
{
...
/*!
    ...
    */
void QwtDataSetCurve::drawDots(QPainter *painter,
                                const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                                int from, int to) const
{
...
/*!
    ...
    */
void QwtDataSetCurve::drawSteps(QPainter *painter,
                                 const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                                 int from, int to) const
{
...
/*!
    ...
    */
void QwtDataSetCurve::setCurveAttribute(CurveAttribute attribute, bool on)
{
...
/*!
        ...
        \sa CurveAttribute, setCurveAttribute()
    */
bool QwtDataSetCurve::testCurveAttribute(CurveAttribute attribute) const
{
...
/*!
    ...
    */
void QwtDataSetCurve::setCurveType(CurveType curveType)
{
...
/*!
    ...
    */
QwtDataSetCurve::CurveType QwtDataSetCurve::curveType() const
{
...
/*!
    ...
    */
void QwtDataSetCurve::setCurveFitter(QwtCurveFitter *curveFitter)
{
...
/*!
      ...
      \return Curve fitter
    */
QwtCurveFitter *QwtDataSetCurve::curveFitter() const
{
...
/*!
    ...
    */
void QwtDataSetCurve::fillCurve(QPainter *painter,
                                 const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                                 QwtPolygon &pa) const
{
    if ( d_data->brush.style() == Qt::NoBrush )
...
/*!
    ...
    */
void QwtDataSetCurve::closePolyline(
        const QwtScaleMap &xMap, const QwtScaleMap &yMap,
        QwtPolygon &pa) const
{
    ...
    if ( d_data->curveType == QwtDataSetCurve::Xfy )
    {
        pa.setPoint(sz,
...
/*!
    ...
    */
void QwtDataSetCurve::drawSymbols(QPainter *painter, const QwtSymbol &symbol,
                                   const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                                   int from, int to) const
{
...
/*!
      ...
      of the baseline depends on the CurveType. With QwtDataSetCurve::Yfx,
      the baseline is interpreted as a horizontal line at y = baseline(),
      with QwtDataSetCurve::Yfy, it is interpreted as a vertical line at
      x = baseline().
      \param reference baseline
      \sa baseline(), setBrush(), setStyle(), setCurveType()
    */
void QwtDataSetCurve::setBaseline(double reference)
{
...
/*!
        ...
        \sa setBaseline()
    */
double QwtDataSetCurve::baseline() const
{
...
/*!
      ...
      \sa setData()
    */
int QwtDataSetCurve::dataSize() const
{
    return d_xy->size();
}
...
/*!
      ...
      \note closestPoint() implements a dumb algorithm, that iterates
            over all points
    */
int QwtDataSetCurve::closestPoint(const QPoint &pos, double *dist) const
{
...
void QwtDataSetCurve::updateLegend(QwtLegend *legend) const
{
    if ( !legend )
        return;
    ...
    else if (policy == QwtLegend::AutoIdentifier)
    {
        ...
        if (QwtDataSetCurve::NoCurve != style())
        {
            legendItem->setCurvePen(pen());

...
#ifndef QWT_Z_ZETA_CURVE_H
#define QWT_Z_ZETA_CURVE_H
...
/*!
  ...
  The QwtZZetaCurve class can be used to draw a coordinate grid.
...
class QWT_EXPORT QwtZZetaCurve: public QwtControlPlotItem
{
    Q_OBJECT
public slots:
    void valueChangeSlot(QPair<QString,double> MarkerPair, bool Restart);
public:
    explicit QwtZZetaCurve();
    virtual ~QwtZZetaCurve();

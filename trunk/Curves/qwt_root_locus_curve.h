#ifndef QWT_ROOT_LOCUS_CURVE_H
#define QWT_ROOT_LOCUS_CURVE_H
...
/*!
  ...
  <dd>QwtRootLocusCurve gets its points using a QwtData object offering
  ...
  the points inside ( like QStandardItemModel ). QwtRootLocusCurve also offers
...
*/
class QWT_EXPORT QwtRootLocusCurve: public QwtControlPlotItem
{
    Q_OBJECT
signals:
...
public:
    ...
    /*!
        Curve styles.
         ...
         - UserCurve\n
           ...
           classes of QwtRootLocusCurve that overload drawCurve() with
    ...
    */
    ...
    /*!
      ...
      - Fitted ( in combination with the Lines QwtRootLocusCurve::CurveStyle only )\n
        ...
        to fit the points, before they are passed to QwtRootLocusCurve.
      - Inverted\n
    ...
    */
    ...
    explicit QwtRootLocusCurve(ControlExpression *Expression, EvalInfo EvInfo);
    explicit QwtRootLocusCurve(const QwtText &title, ControlExpression *Expression, EvalInfo EvInfo);
    explicit QwtRootLocusCurve(const QString &title, ControlExpression *Expression, EvalInfo EvInfo);
...
inline QwtData &QwtRootLocusCurve::data()
{
    return *d_xy;
}

//! \return the the curve data
inline const QwtData &QwtRootLocusCurve::data() const
{
    return *d_xy;
}
...
*/
inline double QwtRootLocusCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double QwtRootLocusCurve::y(int i) const
{
    return d_xy->y(i);
}

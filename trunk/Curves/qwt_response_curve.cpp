...
class QwtResponseCurvePaintHelper: public QObject
{
public:
    QwtResponseCurvePaintHelper(const QwtResponseCurve *curve, int from, int to):
        _curve(curve),
        _from(from),
        _to(to)
    {
...
class QwtResponseCurve::PrivateData
{
public:
    ...
    QwtResponseCurve::CurveType curveType;
    QwtResponseCurve::CurveStyle style;
    double reference;
...
//! Destructor
QwtResponseCurve::~QwtResponseCurve()
{
    this->terminate();
    delete d_xy;
    delete d_data;
...
*/
void QwtResponseCurve::init(ControlExpression *Expression, EvalInfo EvInfo)
{
...
int QwtResponseCurve::rtti() const
{
    return QwtPlotItem::Rtti_PlotUserItem+Rtti_PlotResponse;
}
...
*/
void QwtResponseCurve::setPaintAttribute(PaintAttribute attribute, bool on)
{
    if ( on )
...
*/
bool QwtResponseCurve::testPaintAttribute(PaintAttribute attribute) const
{
...
/*!
  ...
  \sa CurveStyle, style()
*/
void QwtResponseCurve::setStyle(CurveStyle style)
{
...
*/
QwtResponseCurve::CurveStyle QwtResponseCurve::style() const
{
    return d_data->style;
}
...
/*!
  ...
  \sa symbol()
*/
void QwtResponseCurve::setSymbol(const QwtSymbol &symbol )
{
...
/*!
    ...
    \sa setSymbol()
*/
const QwtSymbol &QwtResponseCurve::symbol() const
{
...
*/
void QwtResponseCurve::setPen(const QPen &pen)
{
    if ( pen != d_data->pen )
    {
        d_data->pen = pen;
...
/*!
    ...
    \sa setPen(), brush()
*/
const QPen& QwtResponseCurve::pen() const
{
    return d_data->pen;
}
...
/*!
  \brief Assign a brush.
   ...
   and style() != QwtResponseCurve::Sticks
...
*/
void QwtResponseCurve::setBrush(const QBrush &brush)
{
...
*/
const QBrush& QwtResponseCurve::brush() const
{
    return d_data->brush;
}
...
*/
void QwtResponseCurve::setData(const double *xData, const double *yData, int size)
{
    delete d_xy;
...
/*!
  ...
  \note Internally the data is stored in a QwtArrayData object
*/
void QwtResponseCurve::setData(const QwtArray<double> &xData,
...
*/
#if QT_VERSION < 0x040000
void QwtResponseCurve::setData(const QwtArray<QwtDoublePoint> &data)
#else
void QwtResponseCurve::setData(const QPolygonF &data)
#endif
{
    delete d_xy;
...
/*!
  ...
  \sa QwtData::copy()
*/
void QwtResponseCurve::setData(const QwtData &data)
{
    delete d_xy;
    d_xy = data.copy();
    itemChanged();
...
*/
void QwtResponseCurve::setRawData(const double *xData, const double *yData, int size)
{
    delete d_xy;
...
QwtDoubleRect QwtResponseCurve::boundingRect() const
{
    if ( d_xy == NULL )
...
*/
void QwtResponseCurve::draw(QPainter *painter,
...
/*!
  ...
  \sa drawCurve(), drawSymbols()
*/
void QwtResponseCurve::draw(int from, int to) const
{
    if ( !plot() )
        return;
        ...
        !canvas->testAttribute(Qt::WA_PaintOutsidePaintEvent) )
    {
        /*
          ...
          the QwtResponseCurve::draw, but now from inside the paint
          event.
         */

        QwtResponseCurvePaintHelper helper(this, from, to);
...
/*!
  ...
  \param painter Painter
  \param style curve style, see QwtResponseCurve::CurveStyle
  \param xMap x map
  \param yMap y map
  \param from index of the first point to be painted
...
void QwtResponseCurve::drawCurve(QPainter *painter, int style,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
    switch (style)
...
*/
void QwtResponseCurve::drawLines(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
    int size = to - from + 1;
...
*/
void QwtResponseCurve::drawSticks(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
*/
void QwtResponseCurve::drawDots(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
*/
void QwtResponseCurve::drawSteps(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
*/
void QwtResponseCurve::setCurveAttribute(CurveAttribute attribute, bool on)
{
...
/*!
    ...
    \sa CurveAttribute, setCurveAttribute()
*/
bool QwtResponseCurve::testCurveAttribute(CurveAttribute attribute) const
{
...
*/
void QwtResponseCurve::setCurveType(CurveType curveType)
{
...
*/
QwtResponseCurve::CurveType QwtResponseCurve::curveType() const
{
...
*/
void QwtResponseCurve::setCurveFitter(QwtCurveFitter *curveFitter)
{
...
/*!
  ...
  \return Curve fitter
*/
QwtCurveFitter *QwtResponseCurve::curveFitter() const
{
...
*/
void QwtResponseCurve::fillCurve(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    QwtPolygon &pa) const
{
    if ( d_data->brush.style() == Qt::NoBrush )
...
*/
void QwtResponseCurve::closePolyline(
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    QwtPolygon &pa) const
{
    ...
    if ( d_data->curveType == QwtResponseCurve::Xfy )
    {
        pa.setPoint(sz,
...
*/
void QwtResponseCurve::drawSymbols(QPainter *painter, const QwtSymbol &symbol,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
/*!
  ...
  of the baseline depends on the CurveType. With QwtResponseCurve::Yfx,
  the baseline is interpreted as a horizontal line at y = baseline(),
  with QwtResponseCurve::Yfy, it is interpreted as a vertical line at
  x = baseline().
  \param reference baseline
  \sa baseline(), setBrush(), setStyle(), setCurveType()
*/
void QwtResponseCurve::setBaseline(double reference)
{
...
/*!
    ...
    \sa setBaseline()
*/
double QwtResponseCurve::baseline() const
{
...
/*!
  ...
  \sa setData()
*/
int QwtResponseCurve::dataSize() const
{
    return d_xy->size();
}
...
/*!
  ...
  \note closestPoint() implements a dumb algorithm, that iterates
        over all points
*/
int QwtResponseCurve::closestPoint(const QPoint &pos, double *dist) const
{
...
void QwtResponseCurve::updateLegend(QwtLegend *legend) const
{
    if ( !legend )
        return;
    ...
    else if (policy == QwtLegend::AutoIdentifier)
    {
        ...
        if (QwtResponseCurve::NoCurve != style())
        {
            legendItem->setCurvePen(pen());

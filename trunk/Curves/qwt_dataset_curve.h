#ifndef QWT_DATASET_CURVE_H
#define QWT_DATASET_CURVE_H
...
/*!
  ...
  <dd>QwtDataSetCurve gets its points using a QwtData object offering
  ...
  the points inside ( like QStandardItemModel ). QwtDataSetCurve also offers
...
*/
class QWT_EXPORT QwtDataSetCurve: public QThread, public QwtControlPlotItem
{
    Q_OBJECT
signals:
...
public:
    ...
    /*!
        Curve styles.
         ...
         - UserCurve\n
           ...
           classes of QwtDataSetCurve that overload drawCurve() with
    ...
    */
    ...
    /*!
      ...
      - Fitted ( in combination with the Lines QwtDataSetCurve::CurveStyle only )\n
        ...
        to fit the points, before they are passed to QwtDataSetCurve.
      - Inverted\n
    ...
    */
    ...
    explicit QwtDataSetCurve(QPolygonF Dataset, EvalInfo EvInfo);
    explicit QwtDataSetCurve(const QwtText &title, QPolygonF Dataset, EvalInfo EvInfo);
    explicit QwtDataSetCurve(const QString &title, QPolygonF Dataset, EvalInfo EvInfo);

    EvalInfo *getEvalInfoPtr(void)
    {
        return &EvaluationInfo;
    }
    ControlExpression *getExpressionPtr()
    {
        return NULL;
    }
...
inline QwtData &QwtDataSetCurve::data()
{
    return *d_xy;
}

//! \return the the curve data
inline const QwtData &QwtDataSetCurve::data() const
{
    return *d_xy;
}
...
*/
inline double QwtDataSetCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double QwtDataSetCurve::y(int i) const
{
    return d_xy->y(i);
}


#endif // QWT_DATASET_CURVE_H

#ifndef QWT_MAGNITUDE_CURVE_H
#define QWT_MAGNITUDE_CURVE_H
...
/*!
  ...
  <dd>QwtMagnitudeCurve gets its points using a QwtData object offering
  ...
  the points inside ( like QStandardItemModel ). QwtMagnitudeCurve also offers
...
*/
class QWT_EXPORT QwtMagnitudeCurve: public QThread, public QwtControlPlotItem
{
    Q_OBJECT
signals:
...
public:
    ...
    /*!
        Curve styles.
         ...
         - UserCurve\n
           ...
           classes of QwtMagnitudeCurve that overload drawCurve() with
    ...
    */
    ...
    /*!
      ...
      - Fitted ( in combination with the Lines QwtMagnitudeCurve::CurveStyle only )\n
        ...
        to fit the points, before they are passed to QwtMagnitudeCurve.
      - Inverted\n
    ...
    */
    ...
    explicit QwtMagnitudeCurve(ControlExpression *Expression, EvalInfo EvInfo);
    explicit QwtMagnitudeCurve(const QwtText &title, ControlExpression *Expression, EvalInfo EvInfo);
    explicit QwtMagnitudeCurve(const QString &title, ControlExpression *Expression, EvalInfo EvInfo);
...
inline QwtData &QwtMagnitudeCurve::data()
{
    return *d_xy;
}

//! \return the the curve data
inline const QwtData &QwtMagnitudeCurve::data() const
{
    return *d_xy;
}
...
*/
inline double QwtMagnitudeCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double QwtMagnitudeCurve::y(int i) const
{
    return d_xy->y(i);
}

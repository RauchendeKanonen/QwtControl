#ifndef QWT_DISCRETE_RESPONSE_CURVE_H
#define QWT_DISCRETE_RESPONSE_CURVE_H
...
/*!
  ...
  <dd>QwtDiscreteResponseCurve gets its points using a QwtData object offering
  ...
  the points inside ( like QStandardItemModel ). QwtDiscreteResponseCurve also offers
...
*/
class QWT_EXPORT QwtDiscreteResponseCurve: public QwtControlPlotItem
{
    Q_OBJECT
signals:
...
public:
    ...
    /*!
        Curve styles.
         ...
         - UserCurve\n
           ...
           classes of QwtDiscreteResponseCurve that overload drawCurve() with
    ...
    */
    ...
    /*!
      ...
      - Fitted ( in combination with the Lines QwtDiscreteResponseCurve::CurveStyle only )\n
        ...
        to fit the points, before they are passed to QwtDiscreteResponseCurve.
      - Inverted\n
    ...
    */
    ...
    explicit QwtDiscreteResponseCurve(QString Expression, EvalInfo EvInfo);
    explicit QwtDiscreteResponseCurve(const QwtText &title, QString Expression, EvalInfo EvInfo);
    explicit QwtDiscreteResponseCurve(const QString &title, QString Expression, EvalInfo EvInfo);
    ...
    {
        return new ControlExpression("not available");
    }
...
protected:
    ...
    void init(QString Expression, EvalInfo Evinfo);
...
inline QwtData &QwtDiscreteResponseCurve::data()
{
    return *d_xy;
}

//! \return the the curve data
inline const QwtData &QwtDiscreteResponseCurve::data() const
{
    return *d_xy;
}
...
*/
inline double QwtDiscreteResponseCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double QwtDiscreteResponseCurve::y(int i) const
{
    return d_xy->y(i);
}


#endif // QWT_RESPONSE_CURVE_H

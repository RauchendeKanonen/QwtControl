#ifndef QWT_RESPONSE_CURVE_H
#define QWT_RESPONSE_CURVE_H
...
/*!
  ...
  <dd>QwtResponseCurve gets its points using a QwtData object offering
  ...
  the points inside ( like QStandardItemModel ). QwtResponseCurve also offers
...
public:
    ...
    /*!
        Curve styles.
         ...
         - UserCurve\n
           ...
           classes of QwtResponseCurve that overload drawCurve() with
    ...
    */
    ...
    /*!
      ...
      - Fitted ( in combination with the Lines QwtResponseCurve::CurveStyle only )\n
        ...
        to fit the points, before they are passed to QwtResponseCurve.
      - Inverted\n
...
inline QwtData &QwtResponseCurve::data()
{
    return *d_xy;
}

//! \return the the curve data
inline const QwtData &QwtResponseCurve::data() const
{
    return *d_xy;
}
...
*/
inline double QwtResponseCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double QwtResponseCurve::y(int i) const
{
    return d_xy->y(i);
}

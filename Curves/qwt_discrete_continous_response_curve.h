#ifndef QWT_DISCRETE_CONTINOUS_RESPONSE_CURVE_H
#define QWT_DISCRETE_CONTINOUS_RESPONSE_CURVE_H
...
/*!
  ...
  <dd>QwtDiscreteContinousResponseCurve gets its points using a QwtData object offering
  ...
  the points inside ( like QStandardItemModel ). QwtDiscreteContinousResponseCurve also offers
...
*/
class QWT_EXPORT QwtDiscreteContinousResponseCurve: public QwtControlPlotItem
{
    Q_OBJECT
signals:
...
public:
    ...
    /*!
        Curve styles.
         ...
         - UserCurve\n
           ...
           classes of QwtDiscreteContinousResponseCurve that overload drawCurve() with
    ...
    */
    ...
    /*!
      ...
      - Fitted ( in combination with the Lines QwtDiscreteContinousResponseCurve::CurveStyle only )\n
        ...
        to fit the points, before they are passed to QwtDiscreteContinousResponseCurve.
      - Inverted\n
    ...
    */
    ...
    virtual ~QwtDiscreteContinousResponseCurve();
...
protected:
    ...
    void init(QStringList Expression, EvalInfo Evinfo);
...
private:
    ...
    ControlExpression *pSysExpression;
...
inline QwtData &QwtDiscreteContinousResponseCurve::data()
{
    return *d_xy;
}

//! \return the the curve data
inline const QwtData &QwtDiscreteContinousResponseCurve::data() const
{
    return *d_xy;
}
...
*/
inline double QwtDiscreteContinousResponseCurve::x(int i) const
{
    return d_xy->x(i);
}
...
*/
inline double QwtDiscreteContinousResponseCurve::y(int i) const
{
    return d_xy->y(i);
}

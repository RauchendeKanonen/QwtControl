...
class QwtDiscreteResponseCurvePaintHelper: public QObject
{
public:
    QwtDiscreteResponseCurvePaintHelper(const QwtDiscreteResponseCurve *curve, int from, int to):
        _curve(curve),
        _from(from),
        _to(to)
    {
...
private:
    const QwtDiscreteResponseCurve *_curve;
    int _from;
    int _to;
};
...
class QwtDiscreteResponseCurve::PrivateData
{
public:
    ...
    PrivateData():
        curveType(Yfx),
        style(QwtDiscreteResponseCurve::Lines),
        reference(0.0),
        attributes(0),
        paintAttributes(0)
    {
    ...
    QwtDiscreteResponseCurve::CurveType curveType;
    QwtDiscreteResponseCurve::CurveStyle style;
    double reference;
...
void QwtDiscreteResponseCurve::run (void)
{
    QPolygonF Polygon;
...
void QwtDiscreteResponseCurve::dataReadySlot(QPolygonF Polygon)
{
    setData(Polygon);
    if(plot())
        plot()->replot();
...
void QwtDiscreteResponseCurve::markerChangeSlot(QPair<QString,double> MarkerPair)
{
    QwtPlot *Plot = plot();
    if(Plot)
    {
...
void QwtDiscreteResponseCurve::valueChangeSlot(QPair <QString, double> VarPair, bool Restart)
{
    bool Changed = false;
    if(isRunning())
        return;
...
//! Constructor
QwtDiscreteResponseCurve::QwtDiscreteResponseCurve(QString Expression, EvalInfo EvInfo):
    QwtPlotItem(QwtText())
{
...
*/
QwtDiscreteResponseCurve::QwtDiscreteResponseCurve(const QwtText &title, QString Expression, EvalInfo EvInfo):
    QwtPlotItem(title)
{
    init(Expression, EvInfo);
}
...
/*!
  ...
  \param title Title of the curve
*/
QwtDiscreteResponseCurve::QwtDiscreteResponseCurve(const QString &title, QString Expression, EvalInfo EvInfo):
...
//! Destructor
QwtDiscreteResponseCurve::~QwtDiscreteResponseCurve()
{
    this->terminate();
    delete d_xy;
    delete d_data;
...
*/
void QwtDiscreteResponseCurve::init(QString Expression, EvalInfo EvInfo)
{
    ...
    DiscreteEvaluator->SetExpr(Expression.toStdString());



    setStyle(QwtDiscreteResponseCurve::Steps);
...
int QwtDiscreteResponseCurve::rtti() const
{
...
*/
void QwtDiscreteResponseCurve::setPaintAttribute(PaintAttribute attribute, bool on)
{
    if ( on )
...
*/
bool QwtDiscreteResponseCurve::testPaintAttribute(PaintAttribute attribute) const
{
...
/*!
  ...
  \sa CurveStyle, style()
*/
void QwtDiscreteResponseCurve::setStyle(CurveStyle style)
{
...
*/
QwtDiscreteResponseCurve::CurveStyle QwtDiscreteResponseCurve::style() const
{
    return d_data->style;
}
...
/*!
  ...
  \sa symbol()
*/
void QwtDiscreteResponseCurve::setSymbol(const QwtSymbol &symbol )
{
...
/*!
    ...
    \sa setSymbol()
*/
const QwtSymbol &QwtDiscreteResponseCurve::symbol() const
{
...
*/
void QwtDiscreteResponseCurve::setPen(const QPen &pen)
{
    if ( pen != d_data->pen )
    {
        d_data->pen = pen;
...
/*!
    ...
    \sa setPen(), brush()
*/
const QPen& QwtDiscreteResponseCurve::pen() const
{
    return d_data->pen;
}
...
/*!
  \brief Assign a brush.
   ...
   and style() != QwtDiscreteResponseCurve::Sticks
...
*/
void QwtDiscreteResponseCurve::setBrush(const QBrush &brush)
{
...
*/
const QBrush& QwtDiscreteResponseCurve::brush() const
{
    return d_data->brush;
}
...
*/
void QwtDiscreteResponseCurve::setData(const double *xData, const double *yData, int size)
{
    delete d_xy;
...
/*!
  ...
  \note Internally the data is stored in a QwtArrayData object
*/
void QwtDiscreteResponseCurve::setData(const QwtArray<double> &xData,
...
*/
#if QT_VERSION < 0x040000
void QwtDiscreteResponseCurve::setData(const QwtArray<QwtDoublePoint> &data)
#else
void QwtDiscreteResponseCurve::setData(const QPolygonF &data)
#endif
{
    delete d_xy;
...
/*!
  ...
  \sa QwtData::copy()
*/
void QwtDiscreteResponseCurve::setData(const QwtData &data)
{
    delete d_xy;
    d_xy = data.copy();
    itemChanged();
...
*/
void QwtDiscreteResponseCurve::setRawData(const double *xData, const double *yData, int size)
{
    delete d_xy;
...
QwtDoubleRect QwtDiscreteResponseCurve::boundingRect() const
{
    if ( d_xy == NULL )
...
*/
void QwtDiscreteResponseCurve::draw(QPainter *painter,
...
/*!
  ...
  \sa drawCurve(), drawSymbols()
*/
void QwtDiscreteResponseCurve::draw(int from, int to) const
{
    if ( !plot() )
        return;
        ...
        !canvas->testAttribute(Qt::WA_PaintOutsidePaintEvent) )
    {
        /*
          ...
          the QwtDiscreteResponseCurve::draw, but now from inside the paint
          event.
         */

        QwtDiscreteResponseCurvePaintHelper helper(this, from, to);
...
/*!
  ...
  \param painter Painter
  \param style curve style, see QwtDiscreteResponseCurve::CurveStyle
  \param xMap x map
  \param yMap y map
  \param from index of the first point to be painted
...
void QwtDiscreteResponseCurve::drawCurve(QPainter *painter, int style,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
    switch (style)
...
*/
void QwtDiscreteResponseCurve::drawLines(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
    int size = to - from + 1;
...
*/
void QwtDiscreteResponseCurve::drawSticks(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
*/
void QwtDiscreteResponseCurve::drawDots(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
*/
void QwtDiscreteResponseCurve::drawSteps(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
*/
void QwtDiscreteResponseCurve::setCurveAttribute(CurveAttribute attribute, bool on)
{
...
/*!
    ...
    \sa CurveAttribute, setCurveAttribute()
*/
bool QwtDiscreteResponseCurve::testCurveAttribute(CurveAttribute attribute) const
{
...
*/
void QwtDiscreteResponseCurve::setCurveType(CurveType curveType)
{
...
*/
QwtDiscreteResponseCurve::CurveType QwtDiscreteResponseCurve::curveType() const
{
...
*/
void QwtDiscreteResponseCurve::setCurveFitter(QwtCurveFitter *curveFitter)
{
...
/*!
  ...
  \return Curve fitter
*/
QwtCurveFitter *QwtDiscreteResponseCurve::curveFitter() const
{
...
*/
void QwtDiscreteResponseCurve::fillCurve(QPainter *painter,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    QwtPolygon &pa) const
{
    if ( d_data->brush.style() == Qt::NoBrush )
...
*/
void QwtDiscreteResponseCurve::closePolyline(
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    QwtPolygon &pa) const
{
    ...
    if ( d_data->curveType == QwtDiscreteResponseCurve::Xfy )
    {
        pa.setPoint(sz,
...
*/
void QwtDiscreteResponseCurve::drawSymbols(QPainter *painter, const QwtSymbol &symbol,
    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
    int from, int to) const
{
...
/*!
  ...
  of the baseline depends on the CurveType. With QwtDiscreteResponseCurve::Yfx,
  the baseline is interpreted as a horizontal line at y = baseline(),
  with QwtDiscreteResponseCurve::Yfy, it is interpreted as a vertical line at
  x = baseline().
  \param reference baseline
  \sa baseline(), setBrush(), setStyle(), setCurveType()
*/
void QwtDiscreteResponseCurve::setBaseline(double reference)
{
...
/*!
    ...
    \sa setBaseline()
*/
double QwtDiscreteResponseCurve::baseline() const
{
...
/*!
  ...
  \sa setData()
*/
int QwtDiscreteResponseCurve::dataSize() const
{
    return d_xy->size();
}
...
/*!
  ...
  \note closestPoint() implements a dumb algorithm, that iterates
        over all points
*/
int QwtDiscreteResponseCurve::closestPoint(const QPoint &pos, double *dist) const
{
...
void QwtDiscreteResponseCurve::updateLegend(QwtLegend *legend) const
{
    if ( !legend )
        return;
    ...
    else if (policy == QwtLegend::AutoIdentifier)
    {
        ...
        if (QwtDiscreteResponseCurve::NoCurve != style())
        {
            legendItem->setCurvePen(pen());
